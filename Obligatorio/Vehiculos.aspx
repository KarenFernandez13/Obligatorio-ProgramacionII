...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class=" row">
        <div class="col-lg-8">
            <asp:TextBox ID="txtCantPasajeros" runat="server" CssClass="form-control" TextMode="Number" Visible="false" placeholder="Cantidad de pasajeros" OnTextChanged="txtCantPasajeros_TextChanged"></asp:TextBox>
        </div>
    </div>
    <div class=" row">
        <div class="col-lg-8">
            ...
            <asp:GridView ID="gvVehiculos" runat="server" Width="80%" BorderWidth="2px" CellSpacing="5"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Color">
                        <ItemTemplate>
                            <asp:Label ID="lbl5" runat="server" Text='<%# Bind("Color") %>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Kilometros">
                        <ItemTemplate>
                            <asp:Label ID="lbl5" runat="server" Text='<%# Bind("Kilometros") %>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="ImagenUno">
                        <ItemTemplate>
                            <asp:Image ID="lbl4" runat="server" ImageUrl='<%# Bind("ImagenUno") %>' Width="200"></asp:Image>
                        </ItemTemplate>
                        <EditItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="ImagenDos">
                        <ItemTemplate>
                            <asp:Image ID="lbl4" runat="server" ImageUrl='<%# Bind("ImagenDos") %>' Width="200"></asp:Image>
                        </ItemTemplate>
                        <EditItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="ImagenTres">
                        <ItemTemplate>
                            <asp:Image ID="lbl4" runat="server" ImageUrl='<%# Bind("ImagenTres") %>' Width="200"></asp:Image>
                        </ItemTemplate>
                        <EditItemTemplate>
